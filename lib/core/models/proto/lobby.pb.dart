...
class LobbyEnvelope extends $pb.GeneratedMessage {
  factory LobbyEnvelope({
    ...
    if (modeChangeRequest != null) {
      $result.modeChangeRequest = modeChangeRequest;
    }
  ...
  factory LobbyEnvelope.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LobbyEnvelope.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, LobbyEnvelope_Payload>
      _LobbyEnvelope_PayloadByTag = {
    ...
    26: LobbyEnvelope_Payload.modeChangeRequest,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LobbyEnvelope',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
    ...
    ..aOM<LoginRequest>(10, _omitFieldNames ? '' : 'loginRequest',
        subBuilder: LoginRequest.create)
    ..aOM<LogoutRequest>(11, _omitFieldNames ? '' : 'logoutRequest',
        subBuilder: LogoutRequest.create)
    ..aOM<MoveRequest>(12, _omitFieldNames ? '' : 'moveRequest',
        subBuilder: MoveRequest.create)
    ..aOM<ChatSendRequest>(13, _omitFieldNames ? '' : 'chatSendRequest',
        subBuilder: ChatSendRequest.create)
    ..aOM<ProfileAnonymousChangeRequest>(
        14, _omitFieldNames ? '' : 'profileAnonymousChangeRequest',
        subBuilder: ProfileAnonymousChangeRequest.create)
    ..aOM<ProfileSpriteChangeRequest>(
        15, _omitFieldNames ? '' : 'profileSpriteChangeRequest',
        subBuilder: ProfileSpriteChangeRequest.create)
    ..aOM<ProfileStatusTextUpdateRequest>(
        16, _omitFieldNames ? '' : 'profileStatusTextUpdateRequest',
        subBuilder: ProfileStatusTextUpdateRequest.create)
    ..aOM<ProfileDisplayNameUpdateRequest>(
        17, _omitFieldNames ? '' : 'profileDisplayNameUpdateRequest',
        subBuilder: ProfileDisplayNameUpdateRequest.create)
    ..aOM<SnapshotRequest>(18, _omitFieldNames ? '' : 'snapshotRequest',
        subBuilder: SnapshotRequest.create)
    ..aOM<AssetsRequest>(19, _omitFieldNames ? '' : 'assetsRequest',
        subBuilder: AssetsRequest.create)
    ..aOM<BroadcastSendRequest>(
        20, _omitFieldNames ? '' : 'broadcastSendRequest',
        subBuilder: BroadcastSendRequest.create)
    ..aOM<BroadcastCDRequest>(21, _omitFieldNames ? '' : 'broadcastCdRequest',
        subBuilder: BroadcastCDRequest.create)
    ..aOM<PortalUseRequest>(22, _omitFieldNames ? '' : 'portalUseRequest',
        subBuilder: PortalUseRequest.create)
    ..aOM<OnlineStatsRequest>(23, _omitFieldNames ? '' : 'onlineStatsRequest',
        subBuilder: OnlineStatsRequest.create)
    ..aOM<ProfileSteamBindRequest>(
        24, _omitFieldNames ? '' : 'profileSteamBindRequest',
        subBuilder: ProfileSteamBindRequest.create)
    ..aOM<EnterRequest>(25, _omitFieldNames ? '' : 'enterRequest',
        subBuilder: EnterRequest.create)
    ..aOM<ModeChangeRequest>(26, _omitFieldNames ? '' : 'modeChangeRequest',
        subBuilder: ModeChangeRequest.create)
    ..aOM<LoginSuccessResponse>(
        50, _omitFieldNames ? '' : 'loginSuccessResponse',
        subBuilder: LoginSuccessResponse.create)
    ..aOM<LoginFailedResponse>(51, _omitFieldNames ? '' : 'loginFailedResponse',
        subBuilder: LoginFailedResponse.create)
    ..aOM<LogoutSuccessResponse>(
        52, _omitFieldNames ? '' : 'logoutSuccessResponse',
        subBuilder: LogoutSuccessResponse.create)
    ..aOM<JoinSuccessResponse>(53, _omitFieldNames ? '' : 'joinSuccessResponse',
        subBuilder: JoinSuccessResponse.create)
    ..aOM<SnapshotResponse>(54, _omitFieldNames ? '' : 'snapshotResponse',
        subBuilder: SnapshotResponse.create)
    ..aOM<PresenceJoinResponse>(
        55, _omitFieldNames ? '' : 'presenceJoinResponse',
        subBuilder: PresenceJoinResponse.create)
    ..aOM<PresenceLeaveResponse>(
        56, _omitFieldNames ? '' : 'presenceLeaveResponse',
        subBuilder: PresenceLeaveResponse.create)
    ..aOM<IdentityChangedResponse>(
        57, _omitFieldNames ? '' : 'identityChangedResponse',
        subBuilder: IdentityChangedResponse.create)
    ..aOM<MoveBroadcastResponse>(
        58, _omitFieldNames ? '' : 'moveBroadcastResponse',
        subBuilder: MoveBroadcastResponse.create)
    ..aOM<MoveRejectResponse>(59, _omitFieldNames ? '' : 'moveRejectResponse',
        subBuilder: MoveRejectResponse.create)
    ..aOM<ChatMessageResponse>(60, _omitFieldNames ? '' : 'chatMessageResponse',
        subBuilder: ChatMessageResponse.create)
    ..aOM<ChatRejectResponse>(61, _omitFieldNames ? '' : 'chatRejectResponse',
        subBuilder: ChatRejectResponse.create)
    ..aOM<AnonymousChangedResponse>(
        62, _omitFieldNames ? '' : 'anonymousChangedResponse',
        subBuilder: AnonymousChangedResponse.create)
    ..aOM<SpriteChangedResponse>(
        63, _omitFieldNames ? '' : 'spriteChangedResponse',
        subBuilder: SpriteChangedResponse.create)
    ..aOM<SpriteChangeRejectResponse>(
        64, _omitFieldNames ? '' : 'spriteChangeRejectResponse',
        subBuilder: SpriteChangeRejectResponse.create)
    ..aOM<StatusTextBroadcastResponse>(
        65, _omitFieldNames ? '' : 'statusTextBroadcastResponse',
        subBuilder: StatusTextBroadcastResponse.create)
    ..aOM<DisplayNameChangedResponse>(
        66, _omitFieldNames ? '' : 'displayNameChangedResponse',
        subBuilder: DisplayNameChangedResponse.create)
    ..aOM<AssetsResponse>(67, _omitFieldNames ? '' : 'assetsResponse',
        subBuilder: AssetsResponse.create)
    ..aOM<AssetsUpdatedResponse>(
        68, _omitFieldNames ? '' : 'assetsUpdatedResponse',
        subBuilder: AssetsUpdatedResponse.create)
    ..aOM<PortalTeleportResponse>(
        69, _omitFieldNames ? '' : 'portalTeleportResponse',
        subBuilder: PortalTeleportResponse.create)
    ..aOM<PortalUseRejectResponse>(
        70, _omitFieldNames ? '' : 'portalUseRejectResponse',
        subBuilder: PortalUseRejectResponse.create)
    ..aOM<BroadcastMessageResponse>(
        71, _omitFieldNames ? '' : 'broadcastMessageResponse',
        subBuilder: BroadcastMessageResponse.create)
    ..aOM<BroadcastRejectResponse>(
        72, _omitFieldNames ? '' : 'broadcastRejectResponse',
        subBuilder: BroadcastRejectResponse.create)
    ..aOM<BroadcastCDResponse>(73, _omitFieldNames ? '' : 'broadcastCdResponse',
        subBuilder: BroadcastCDResponse.create)
    ..aOM<OnlineStatsResponse>(74, _omitFieldNames ? '' : 'onlineStatsResponse',
        subBuilder: OnlineStatsResponse.create)
    ..aOM<SystemErrorResponse>(75, _omitFieldNames ? '' : 'systemErrorResponse',
        subBuilder: SystemErrorResponse.create)
    ..aOM<SystemNoticeResponse>(
        76, _omitFieldNames ? '' : 'systemNoticeResponse',
        subBuilder: SystemNoticeResponse.create)
    ..aOM<SystemKickedResponse>(
        77, _omitFieldNames ? '' : 'systemKickedResponse',
        subBuilder: SystemKickedResponse.create)
    ..aOM<SteamBindSuccessResponse>(
        78, _omitFieldNames ? '' : 'steamBindSuccessResponse',
        subBuilder: SteamBindSuccessResponse.create)
    ..aOM<SpriteChangeSuccessResponse>(
        79, _omitFieldNames ? '' : 'spriteChangeSuccessResponse',
        subBuilder: SpriteChangeSuccessResponse.create)
    ..aOM<PresenceDeltaResponse>(
        80, _omitFieldNames ? '' : 'presenceDeltaResponse',
        subBuilder: PresenceDeltaResponse.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  LobbyEnvelope copyWith(void Function(LobbyEnvelope) updates) =>
      super.copyWith((message) => updates(message as LobbyEnvelope))
          as LobbyEnvelope;
  ...
  static $pb.PbList<LobbyEnvelope> createRepeated() =>
      $pb.PbList<LobbyEnvelope>();
  @$core.pragma('dart2js:noInline')
  static LobbyEnvelope getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LobbyEnvelope>(create);
  static LobbyEnvelope? _defaultInstance;

  LobbyEnvelope_Payload whichPayload() =>
      _LobbyEnvelope_PayloadByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(10)
  set loginRequest(LoginRequest v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(11)
  set logoutRequest(LogoutRequest v) {
    setField(11, v);
  }
  ...
  @$pb.TagNumber(13)
  set chatSendRequest(ChatSendRequest v) {
    setField(13, v);
  }
  ...
  @$pb.TagNumber(14)
  set profileAnonymousChangeRequest(ProfileAnonymousChangeRequest v) {
    setField(14, v);
  }
  ...
  @$pb.TagNumber(14)
  ProfileAnonymousChangeRequest ensureProfileAnonymousChangeRequest() =>
      $_ensure(8);

  @$pb.TagNumber(15)
  ProfileSpriteChangeRequest get profileSpriteChangeRequest => $_getN(9);
  @$pb.TagNumber(15)
  set profileSpriteChangeRequest(ProfileSpriteChangeRequest v) {
    setField(15, v);
  }
  ...
  @$pb.TagNumber(16)
  ProfileStatusTextUpdateRequest get profileStatusTextUpdateRequest =>
      $_getN(10);
  @$pb.TagNumber(16)
  set profileStatusTextUpdateRequest(ProfileStatusTextUpdateRequest v) {
    setField(16, v);
  }
  ...
  @$pb.TagNumber(16)
  ProfileStatusTextUpdateRequest ensureProfileStatusTextUpdateRequest() =>
      $_ensure(10);

  @$pb.TagNumber(17)
  ProfileDisplayNameUpdateRequest get profileDisplayNameUpdateRequest =>
      $_getN(11);
  @$pb.TagNumber(17)
  set profileDisplayNameUpdateRequest(ProfileDisplayNameUpdateRequest v) {
    setField(17, v);
  }
  ...
  @$pb.TagNumber(17)
  ProfileDisplayNameUpdateRequest ensureProfileDisplayNameUpdateRequest() =>
      $_ensure(11);

  @$pb.TagNumber(18)
  SnapshotRequest get snapshotRequest => $_getN(12);
  @$pb.TagNumber(18)
  set snapshotRequest(SnapshotRequest v) {
    setField(18, v);
  }
  ...
  @$pb.TagNumber(19)
  set assetsRequest(AssetsRequest v) {
    setField(19, v);
  }
  ...
  @$pb.TagNumber(20)
  set broadcastSendRequest(BroadcastSendRequest v) {
    setField(20, v);
  }
  ...
  @$pb.TagNumber(21)
  set broadcastCdRequest(BroadcastCDRequest v) {
    setField(21, v);
  }
  ...
  @$pb.TagNumber(22)
  set portalUseRequest(PortalUseRequest v) {
    setField(22, v);
  }
  ...
  @$pb.TagNumber(23)
  set onlineStatsRequest(OnlineStatsRequest v) {
    setField(23, v);
  }
  ...
  @$pb.TagNumber(24)
  set profileSteamBindRequest(ProfileSteamBindRequest v) {
    setField(24, v);
  }
  ...
  @$pb.TagNumber(25)
  set enterRequest(EnterRequest v) {
    setField(25, v);
  }
  ...
  @$pb.TagNumber(26)
  ModeChangeRequest get modeChangeRequest => $_getN(20);
  @$pb.TagNumber(26)
  set modeChangeRequest(ModeChangeRequest v) {
    setField(26, v);
  }

  @$pb.TagNumber(26)
  $core.bool hasModeChangeRequest() => $_has(20);
  @$pb.TagNumber(26)
  void clearModeChangeRequest() => clearField(26);
  @$pb.TagNumber(26)
  ModeChangeRequest ensureModeChangeRequest() => $_ensure(20);

  /// 服务端 -> 客户端
  @$pb.TagNumber(50)
  LoginSuccessResponse get loginSuccessResponse => $_getN(21);
  @$pb.TagNumber(50)
  set loginSuccessResponse(LoginSuccessResponse v) {
    setField(50, v);
  }

  @$pb.TagNumber(50)
  $core.bool hasLoginSuccessResponse() => $_has(21);
  @$pb.TagNumber(50)
  void clearLoginSuccessResponse() => clearField(50);
  @$pb.TagNumber(50)
  LoginSuccessResponse ensureLoginSuccessResponse() => $_ensure(21);

  @$pb.TagNumber(51)
  LoginFailedResponse get loginFailedResponse => $_getN(22);
  @$pb.TagNumber(51)
  set loginFailedResponse(LoginFailedResponse v) {
    setField(51, v);
  }

  @$pb.TagNumber(51)
  $core.bool hasLoginFailedResponse() => $_has(22);
  @$pb.TagNumber(51)
  void clearLoginFailedResponse() => clearField(51);
  @$pb.TagNumber(51)
  LoginFailedResponse ensureLoginFailedResponse() => $_ensure(22);

  @$pb.TagNumber(52)
  LogoutSuccessResponse get logoutSuccessResponse => $_getN(23);
  @$pb.TagNumber(52)
  set logoutSuccessResponse(LogoutSuccessResponse v) {
    setField(52, v);
  }

  @$pb.TagNumber(52)
  $core.bool hasLogoutSuccessResponse() => $_has(23);
  @$pb.TagNumber(52)
  void clearLogoutSuccessResponse() => clearField(52);
  @$pb.TagNumber(52)
  LogoutSuccessResponse ensureLogoutSuccessResponse() => $_ensure(23);

  @$pb.TagNumber(53)
  JoinSuccessResponse get joinSuccessResponse => $_getN(24);
  @$pb.TagNumber(53)
  set joinSuccessResponse(JoinSuccessResponse v) {
    setField(53, v);
  }

  @$pb.TagNumber(53)
  $core.bool hasJoinSuccessResponse() => $_has(24);
  @$pb.TagNumber(53)
  void clearJoinSuccessResponse() => clearField(53);
  @$pb.TagNumber(53)
  JoinSuccessResponse ensureJoinSuccessResponse() => $_ensure(24);

  @$pb.TagNumber(54)
  SnapshotResponse get snapshotResponse => $_getN(25);
  @$pb.TagNumber(54)
  set snapshotResponse(SnapshotResponse v) {
    setField(54, v);
  }

  @$pb.TagNumber(54)
  $core.bool hasSnapshotResponse() => $_has(25);
  @$pb.TagNumber(54)
  void clearSnapshotResponse() => clearField(54);
  @$pb.TagNumber(54)
  SnapshotResponse ensureSnapshotResponse() => $_ensure(25);

  @$pb.TagNumber(55)
  PresenceJoinResponse get presenceJoinResponse => $_getN(26);
  @$pb.TagNumber(55)
  set presenceJoinResponse(PresenceJoinResponse v) {
    setField(55, v);
  }

  @$pb.TagNumber(55)
  $core.bool hasPresenceJoinResponse() => $_has(26);
  @$pb.TagNumber(55)
  void clearPresenceJoinResponse() => clearField(55);
  @$pb.TagNumber(55)
  PresenceJoinResponse ensurePresenceJoinResponse() => $_ensure(26);

  @$pb.TagNumber(56)
  PresenceLeaveResponse get presenceLeaveResponse => $_getN(27);
  @$pb.TagNumber(56)
  set presenceLeaveResponse(PresenceLeaveResponse v) {
    setField(56, v);
  }

  @$pb.TagNumber(56)
  $core.bool hasPresenceLeaveResponse() => $_has(27);
  @$pb.TagNumber(56)
  void clearPresenceLeaveResponse() => clearField(56);
  @$pb.TagNumber(56)
  PresenceLeaveResponse ensurePresenceLeaveResponse() => $_ensure(27);

  @$pb.TagNumber(57)
  IdentityChangedResponse get identityChangedResponse => $_getN(28);
  @$pb.TagNumber(57)
  set identityChangedResponse(IdentityChangedResponse v) {
    setField(57, v);
  }

  @$pb.TagNumber(57)
  $core.bool hasIdentityChangedResponse() => $_has(28);
  @$pb.TagNumber(57)
  void clearIdentityChangedResponse() => clearField(57);
  @$pb.TagNumber(57)
  IdentityChangedResponse ensureIdentityChangedResponse() => $_ensure(28);

  @$pb.TagNumber(58)
  MoveBroadcastResponse get moveBroadcastResponse => $_getN(29);
  @$pb.TagNumber(58)
  set moveBroadcastResponse(MoveBroadcastResponse v) {
    setField(58, v);
  }

  @$pb.TagNumber(58)
  $core.bool hasMoveBroadcastResponse() => $_has(29);
  @$pb.TagNumber(58)
  void clearMoveBroadcastResponse() => clearField(58);
  @$pb.TagNumber(58)
  MoveBroadcastResponse ensureMoveBroadcastResponse() => $_ensure(29);

  @$pb.TagNumber(59)
  MoveRejectResponse get moveRejectResponse => $_getN(30);
  @$pb.TagNumber(59)
  set moveRejectResponse(MoveRejectResponse v) {
    setField(59, v);
  }

  @$pb.TagNumber(59)
  $core.bool hasMoveRejectResponse() => $_has(30);
  @$pb.TagNumber(59)
  void clearMoveRejectResponse() => clearField(59);
  @$pb.TagNumber(59)
  MoveRejectResponse ensureMoveRejectResponse() => $_ensure(30);

  @$pb.TagNumber(60)
  ChatMessageResponse get chatMessageResponse => $_getN(31);
  @$pb.TagNumber(60)
  set chatMessageResponse(ChatMessageResponse v) {
    setField(60, v);
  }

  @$pb.TagNumber(60)
  $core.bool hasChatMessageResponse() => $_has(31);
  @$pb.TagNumber(60)
  void clearChatMessageResponse() => clearField(60);
  @$pb.TagNumber(60)
  ChatMessageResponse ensureChatMessageResponse() => $_ensure(31);

  @$pb.TagNumber(61)
  ChatRejectResponse get chatRejectResponse => $_getN(32);
  @$pb.TagNumber(61)
  set chatRejectResponse(ChatRejectResponse v) {
    setField(61, v);
  }

  @$pb.TagNumber(61)
  $core.bool hasChatRejectResponse() => $_has(32);
  @$pb.TagNumber(61)
  void clearChatRejectResponse() => clearField(61);
  @$pb.TagNumber(61)
  ChatRejectResponse ensureChatRejectResponse() => $_ensure(32);

  @$pb.TagNumber(62)
  AnonymousChangedResponse get anonymousChangedResponse => $_getN(33);
  @$pb.TagNumber(62)
  set anonymousChangedResponse(AnonymousChangedResponse v) {
    setField(62, v);
  }

  @$pb.TagNumber(62)
  $core.bool hasAnonymousChangedResponse() => $_has(33);
  @$pb.TagNumber(62)
  void clearAnonymousChangedResponse() => clearField(62);
  @$pb.TagNumber(62)
  AnonymousChangedResponse ensureAnonymousChangedResponse() => $_ensure(33);

  @$pb.TagNumber(63)
  SpriteChangedResponse get spriteChangedResponse => $_getN(34);
  @$pb.TagNumber(63)
  set spriteChangedResponse(SpriteChangedResponse v) {
    setField(63, v);
  }

  @$pb.TagNumber(63)
  $core.bool hasSpriteChangedResponse() => $_has(34);
  @$pb.TagNumber(63)
  void clearSpriteChangedResponse() => clearField(63);
  @$pb.TagNumber(63)
  SpriteChangedResponse ensureSpriteChangedResponse() => $_ensure(34);

  @$pb.TagNumber(64)
  SpriteChangeRejectResponse get spriteChangeRejectResponse => $_getN(35);
  @$pb.TagNumber(64)
  set spriteChangeRejectResponse(SpriteChangeRejectResponse v) {
    setField(64, v);
  }

  @$pb.TagNumber(64)
  $core.bool hasSpriteChangeRejectResponse() => $_has(35);
  @$pb.TagNumber(64)
  void clearSpriteChangeRejectResponse() => clearField(64);
  @$pb.TagNumber(64)
  SpriteChangeRejectResponse ensureSpriteChangeRejectResponse() => $_ensure(35);

  @$pb.TagNumber(65)
  StatusTextBroadcastResponse get statusTextBroadcastResponse => $_getN(36);
  @$pb.TagNumber(65)
  set statusTextBroadcastResponse(StatusTextBroadcastResponse v) {
    setField(65, v);
  }

  @$pb.TagNumber(65)
  $core.bool hasStatusTextBroadcastResponse() => $_has(36);
  @$pb.TagNumber(65)
  void clearStatusTextBroadcastResponse() => clearField(65);
  @$pb.TagNumber(65)
  StatusTextBroadcastResponse ensureStatusTextBroadcastResponse() =>
      $_ensure(36);

  @$pb.TagNumber(66)
  DisplayNameChangedResponse get displayNameChangedResponse => $_getN(37);
  @$pb.TagNumber(66)
  set displayNameChangedResponse(DisplayNameChangedResponse v) {
    setField(66, v);
  }

  @$pb.TagNumber(66)
  $core.bool hasDisplayNameChangedResponse() => $_has(37);
  @$pb.TagNumber(66)
  void clearDisplayNameChangedResponse() => clearField(66);
  @$pb.TagNumber(66)
  DisplayNameChangedResponse ensureDisplayNameChangedResponse() => $_ensure(37);

  @$pb.TagNumber(67)
  AssetsResponse get assetsResponse => $_getN(38);
  @$pb.TagNumber(67)
  set assetsResponse(AssetsResponse v) {
    setField(67, v);
  }

  @$pb.TagNumber(67)
  $core.bool hasAssetsResponse() => $_has(38);
  @$pb.TagNumber(67)
  void clearAssetsResponse() => clearField(67);
  @$pb.TagNumber(67)
  AssetsResponse ensureAssetsResponse() => $_ensure(38);

  @$pb.TagNumber(68)
  AssetsUpdatedResponse get assetsUpdatedResponse => $_getN(39);
  @$pb.TagNumber(68)
  set assetsUpdatedResponse(AssetsUpdatedResponse v) {
    setField(68, v);
  }

  @$pb.TagNumber(68)
  $core.bool hasAssetsUpdatedResponse() => $_has(39);
  @$pb.TagNumber(68)
  void clearAssetsUpdatedResponse() => clearField(68);
  @$pb.TagNumber(68)
  AssetsUpdatedResponse ensureAssetsUpdatedResponse() => $_ensure(39);

  @$pb.TagNumber(69)
  PortalTeleportResponse get portalTeleportResponse => $_getN(40);
  @$pb.TagNumber(69)
  set portalTeleportResponse(PortalTeleportResponse v) {
    setField(69, v);
  }

  @$pb.TagNumber(69)
  $core.bool hasPortalTeleportResponse() => $_has(40);
  @$pb.TagNumber(69)
  void clearPortalTeleportResponse() => clearField(69);
  @$pb.TagNumber(69)
  PortalTeleportResponse ensurePortalTeleportResponse() => $_ensure(40);

  @$pb.TagNumber(70)
  PortalUseRejectResponse get portalUseRejectResponse => $_getN(41);
  @$pb.TagNumber(70)
  set portalUseRejectResponse(PortalUseRejectResponse v) {
    setField(70, v);
  }

  @$pb.TagNumber(70)
  $core.bool hasPortalUseRejectResponse() => $_has(41);
  @$pb.TagNumber(70)
  void clearPortalUseRejectResponse() => clearField(70);
  @$pb.TagNumber(70)
  PortalUseRejectResponse ensurePortalUseRejectResponse() => $_ensure(41);

  @$pb.TagNumber(71)
  BroadcastMessageResponse get broadcastMessageResponse => $_getN(42);
  @$pb.TagNumber(71)
  set broadcastMessageResponse(BroadcastMessageResponse v) {
    setField(71, v);
  }

  @$pb.TagNumber(71)
  $core.bool hasBroadcastMessageResponse() => $_has(42);
  @$pb.TagNumber(71)
  void clearBroadcastMessageResponse() => clearField(71);
  @$pb.TagNumber(71)
  BroadcastMessageResponse ensureBroadcastMessageResponse() => $_ensure(42);

  @$pb.TagNumber(72)
  BroadcastRejectResponse get broadcastRejectResponse => $_getN(43);
  @$pb.TagNumber(72)
  set broadcastRejectResponse(BroadcastRejectResponse v) {
    setField(72, v);
  }

  @$pb.TagNumber(72)
  $core.bool hasBroadcastRejectResponse() => $_has(43);
  @$pb.TagNumber(72)
  void clearBroadcastRejectResponse() => clearField(72);
  @$pb.TagNumber(72)
  BroadcastRejectResponse ensureBroadcastRejectResponse() => $_ensure(43);

  @$pb.TagNumber(73)
  BroadcastCDResponse get broadcastCdResponse => $_getN(44);
  @$pb.TagNumber(73)
  set broadcastCdResponse(BroadcastCDResponse v) {
    setField(73, v);
  }

  @$pb.TagNumber(73)
  $core.bool hasBroadcastCdResponse() => $_has(44);
  @$pb.TagNumber(73)
  void clearBroadcastCdResponse() => clearField(73);
  @$pb.TagNumber(73)
  BroadcastCDResponse ensureBroadcastCdResponse() => $_ensure(44);

  @$pb.TagNumber(74)
  OnlineStatsResponse get onlineStatsResponse => $_getN(45);
  @$pb.TagNumber(74)
  set onlineStatsResponse(OnlineStatsResponse v) {
    setField(74, v);
  }

  @$pb.TagNumber(74)
  $core.bool hasOnlineStatsResponse() => $_has(45);
  @$pb.TagNumber(74)
  void clearOnlineStatsResponse() => clearField(74);
  @$pb.TagNumber(74)
  OnlineStatsResponse ensureOnlineStatsResponse() => $_ensure(45);

  @$pb.TagNumber(75)
  SystemErrorResponse get systemErrorResponse => $_getN(46);
  @$pb.TagNumber(75)
  set systemErrorResponse(SystemErrorResponse v) {
    setField(75, v);
  }

  @$pb.TagNumber(75)
  $core.bool hasSystemErrorResponse() => $_has(46);
  @$pb.TagNumber(75)
  void clearSystemErrorResponse() => clearField(75);
  @$pb.TagNumber(75)
  SystemErrorResponse ensureSystemErrorResponse() => $_ensure(46);

  @$pb.TagNumber(76)
  SystemNoticeResponse get systemNoticeResponse => $_getN(47);
  @$pb.TagNumber(76)
  set systemNoticeResponse(SystemNoticeResponse v) {
    setField(76, v);
  }

  @$pb.TagNumber(76)
  $core.bool hasSystemNoticeResponse() => $_has(47);
  @$pb.TagNumber(76)
  void clearSystemNoticeResponse() => clearField(76);
  @$pb.TagNumber(76)
  SystemNoticeResponse ensureSystemNoticeResponse() => $_ensure(47);

  @$pb.TagNumber(77)
  SystemKickedResponse get systemKickedResponse => $_getN(48);
  @$pb.TagNumber(77)
  set systemKickedResponse(SystemKickedResponse v) {
    setField(77, v);
  }

  @$pb.TagNumber(77)
  $core.bool hasSystemKickedResponse() => $_has(48);
  @$pb.TagNumber(77)
  void clearSystemKickedResponse() => clearField(77);
  @$pb.TagNumber(77)
  SystemKickedResponse ensureSystemKickedResponse() => $_ensure(48);

  @$pb.TagNumber(78)
  SteamBindSuccessResponse get steamBindSuccessResponse => $_getN(49);
  @$pb.TagNumber(78)
  set steamBindSuccessResponse(SteamBindSuccessResponse v) {
    setField(78, v);
  }

  @$pb.TagNumber(78)
  $core.bool hasSteamBindSuccessResponse() => $_has(49);
  @$pb.TagNumber(78)
  void clearSteamBindSuccessResponse() => clearField(78);
  @$pb.TagNumber(78)
  SteamBindSuccessResponse ensureSteamBindSuccessResponse() => $_ensure(49);

  @$pb.TagNumber(79)
  SpriteChangeSuccessResponse get spriteChangeSuccessResponse => $_getN(50);
  @$pb.TagNumber(79)
  set spriteChangeSuccessResponse(SpriteChangeSuccessResponse v) {
    setField(79, v);
  }

  @$pb.TagNumber(79)
  $core.bool hasSpriteChangeSuccessResponse() => $_has(50);
  @$pb.TagNumber(79)
  void clearSpriteChangeSuccessResponse() => clearField(79);
  @$pb.TagNumber(79)
  SpriteChangeSuccessResponse ensureSpriteChangeSuccessResponse() =>
      $_ensure(50);

  @$pb.TagNumber(80)
  PresenceDeltaResponse get presenceDeltaResponse => $_getN(51);
  @$pb.TagNumber(80)
  set presenceDeltaResponse(PresenceDeltaResponse v) {
    setField(80, v);
  }

  @$pb.TagNumber(80)
  $core.bool hasPresenceDeltaResponse() => $_has(51);
  @$pb.TagNumber(80)
  void clearPresenceDeltaResponse() => clearField(80);
  @$pb.TagNumber(80)
  PresenceDeltaResponse ensurePresenceDeltaResponse() => $_ensure(51);
}
...
class LobbyUser extends $pb.GeneratedMessage {
  ...
  LobbyUser._() : super();
  factory LobbyUser.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LobbyUser.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LobbyUser',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LobbyUser copyWith(void Function(LobbyUser) updates) =>
      super.copyWith((message) => updates(message as LobbyUser)) as LobbyUser;
  ...
  @$core.pragma('dart2js:noInline')
  static LobbyUser getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LobbyUser>(create);
  ...
  @$pb.TagNumber(14)
  set businessUserId($core.String v) {
    $_setString(13, v);
  }
...
class LobbyMessage extends $pb.GeneratedMessage {
  ...
  factory LobbyMessage.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LobbyMessage.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LobbyMessage',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LobbyMessage copyWith(void Function(LobbyMessage) updates) =>
      super.copyWith((message) => updates(message as LobbyMessage))
          as LobbyMessage;
  ...
  static $pb.PbList<LobbyMessage> createRepeated() =>
      $pb.PbList<LobbyMessage>();
  @$core.pragma('dart2js:noInline')
  static LobbyMessage getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LobbyMessage>(create);
...
class LobbyBroadcastMessage extends $pb.GeneratedMessage {
  ...
  factory LobbyBroadcastMessage.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LobbyBroadcastMessage.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LobbyBroadcastMessage',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'messageId')
    ..aOS(2, _omitFieldNames ? '' : 'userId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  LobbyBroadcastMessage clone() =>
      LobbyBroadcastMessage()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LobbyBroadcastMessage copyWith(
          void Function(LobbyBroadcastMessage) updates) =>
      super.copyWith((message) => updates(message as LobbyBroadcastMessage))
          as LobbyBroadcastMessage;
  ...
  static $pb.PbList<LobbyBroadcastMessage> createRepeated() =>
      $pb.PbList<LobbyBroadcastMessage>();
  @$core.pragma('dart2js:noInline')
  static LobbyBroadcastMessage getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LobbyBroadcastMessage>(create);
...
class LobbyMapConfig extends $pb.GeneratedMessage {
  ...
  factory LobbyMapConfig.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LobbyMapConfig.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LobbyMapConfig',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ...
    ..pc<LobbyWalkableArea>(
        6, _omitFieldNames ? '' : 'walkableAreas', $pb.PbFieldType.PM,
        subBuilder: LobbyWalkableArea.create)
    ..pc<LobbyPortal>(7, _omitFieldNames ? '' : 'portals', $pb.PbFieldType.PM,
        subBuilder: LobbyPortal.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LobbyMapConfig copyWith(void Function(LobbyMapConfig) updates) =>
      super.copyWith((message) => updates(message as LobbyMapConfig))
          as LobbyMapConfig;
  ...
  static $pb.PbList<LobbyMapConfig> createRepeated() =>
      $pb.PbList<LobbyMapConfig>();
  @$core.pragma('dart2js:noInline')
  static LobbyMapConfig getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LobbyMapConfig>(create);
...
class LobbyWalkableArea extends $pb.GeneratedMessage {
  ...
  factory LobbyWalkableArea.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LobbyWalkableArea.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LobbyWalkableArea',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LobbyWalkableArea copyWith(void Function(LobbyWalkableArea) updates) =>
      super.copyWith((message) => updates(message as LobbyWalkableArea))
          as LobbyWalkableArea;
  ...
  static $pb.PbList<LobbyWalkableArea> createRepeated() =>
      $pb.PbList<LobbyWalkableArea>();
  @$core.pragma('dart2js:noInline')
  static LobbyWalkableArea getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LobbyWalkableArea>(create);
...
class LobbyPortal extends $pb.GeneratedMessage {
  ...
  LobbyPortal._() : super();
  factory LobbyPortal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LobbyPortal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LobbyPortal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LobbyPortal copyWith(void Function(LobbyPortal) updates) =>
      super.copyWith((message) => updates(message as LobbyPortal))
          as LobbyPortal;
  ...
  @$core.pragma('dart2js:noInline')
  static LobbyPortal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LobbyPortal>(create);
...
class LobbySpriteConfig extends $pb.GeneratedMessage {
  ...
  factory LobbySpriteConfig.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LobbySpriteConfig.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LobbySpriteConfig',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LobbySpriteConfig copyWith(void Function(LobbySpriteConfig) updates) =>
      super.copyWith((message) => updates(message as LobbySpriteConfig))
          as LobbySpriteConfig;
  ...
  static $pb.PbList<LobbySpriteConfig> createRepeated() =>
      $pb.PbList<LobbySpriteConfig>();
  @$core.pragma('dart2js:noInline')
  static LobbySpriteConfig getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LobbySpriteConfig>(create);
...
class EnterRequest extends $pb.GeneratedMessage {
  factory EnterRequest({
    ...
    if (lowBandwidth != null) {
      $result.lowBandwidth = lowBandwidth;
    }
    return $result;
  }
  EnterRequest._() : super();
  factory EnterRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory EnterRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'EnterRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..a<$core.int>(
        1, _omitFieldNames ? '' : 'protocolFeatures', $pb.PbFieldType.O3)
    ..aOB(2, _omitFieldNames ? '' : 'lowBandwidth')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  EnterRequest copyWith(void Function(EnterRequest) updates) =>
      super.copyWith((message) => updates(message as EnterRequest))
          as EnterRequest;
  ...
  static $pb.PbList<EnterRequest> createRepeated() =>
      $pb.PbList<EnterRequest>();
  @$core.pragma('dart2js:noInline')
  static EnterRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EnterRequest>(create);
  ...
  @$pb.TagNumber(1)
  set protocolFeatures($core.int v) {
    $_setSignedInt32(0, v);
  }
  ...
  @$pb.TagNumber(2)
  $core.bool get lowBandwidth => $_getBF(1);
  @$pb.TagNumber(2)
  set lowBandwidth($core.bool v) {
    $_setBool(1, v);
  }

  @$pb.TagNumber(2)
  $core.bool hasLowBandwidth() => $_has(1);
  @$pb.TagNumber(2)
  void clearLowBandwidth() => clearField(2);
}

/// ModeChangeRequest 运行时切换弱网模式（客户端 → 服务端）
/// 进入大厅后随时发送，服务端据此开启 / 关闭高频下行裁剪。
/// 关闭弱网时服务端会主动补发一次全量 snapshot（trace_id 为空）。
/// 切换限流 1 秒 1 次，超出返回 system.error { code: 429 }。
class ModeChangeRequest extends $pb.GeneratedMessage {
  factory ModeChangeRequest({
    $core.bool? lowBandwidth,
  }) {
    final $result = create();
    if (lowBandwidth != null) {
  ...
  ModeChangeRequest._() : super();
  factory ModeChangeRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ModeChangeRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ModeChangeRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'lowBandwidth')
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ModeChangeRequest clone() => ModeChangeRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ModeChangeRequest copyWith(void Function(ModeChangeRequest) updates) =>
      super.copyWith((message) => updates(message as ModeChangeRequest))
          as ModeChangeRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ModeChangeRequest create() => ModeChangeRequest._();
  ModeChangeRequest createEmptyInstance() => create();
  static $pb.PbList<ModeChangeRequest> createRepeated() =>
      $pb.PbList<ModeChangeRequest>();
  @$core.pragma('dart2js:noInline')
  static ModeChangeRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ModeChangeRequest>(create);
  static ModeChangeRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get lowBandwidth => $_getBF(0);
  @$pb.TagNumber(1)
  set lowBandwidth($core.bool v) {
    $_setBool(0, v);
  }
  ...
  @$pb.TagNumber(1)
  $core.bool hasLowBandwidth() => $_has(0);
  @$pb.TagNumber(1)
  void clearLowBandwidth() => clearField(1);
}
...
class MoveRequest extends $pb.GeneratedMessage {
  ...
  MoveRequest._() : super();
  factory MoveRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MoveRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
...
class ChatSendRequest extends $pb.GeneratedMessage {
  ...
  factory ChatSendRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ChatSendRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ChatSendRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ChatSendRequest copyWith(void Function(ChatSendRequest) updates) =>
      super.copyWith((message) => updates(message as ChatSendRequest))
          as ChatSendRequest;
  ...
  static $pb.PbList<ChatSendRequest> createRepeated() =>
      $pb.PbList<ChatSendRequest>();
  @$core.pragma('dart2js:noInline')
  static ChatSendRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ChatSendRequest>(create);
...
class ProfileAnonymousChangeRequest extends $pb.GeneratedMessage {
  ...
  factory ProfileAnonymousChangeRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ProfileAnonymousChangeRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ProfileAnonymousChangeRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ProfileAnonymousChangeRequest clone() =>
      ProfileAnonymousChangeRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ProfileAnonymousChangeRequest copyWith(
          void Function(ProfileAnonymousChangeRequest) updates) =>
      super.copyWith(
              (message) => updates(message as ProfileAnonymousChangeRequest))
          as ProfileAnonymousChangeRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ProfileAnonymousChangeRequest create() =>
      ProfileAnonymousChangeRequest._();
  ProfileAnonymousChangeRequest createEmptyInstance() => create();
  static $pb.PbList<ProfileAnonymousChangeRequest> createRepeated() =>
      $pb.PbList<ProfileAnonymousChangeRequest>();
  @$core.pragma('dart2js:noInline')
  static ProfileAnonymousChangeRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProfileAnonymousChangeRequest>(create);
...
class ProfileSpriteChangeRequest extends $pb.GeneratedMessage {
  ...
  factory ProfileSpriteChangeRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ProfileSpriteChangeRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ProfileSpriteChangeRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ProfileSpriteChangeRequest clone() =>
      ProfileSpriteChangeRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ProfileSpriteChangeRequest copyWith(
          void Function(ProfileSpriteChangeRequest) updates) =>
      super.copyWith(
              (message) => updates(message as ProfileSpriteChangeRequest))
          as ProfileSpriteChangeRequest;
  ...
  static $pb.PbList<ProfileSpriteChangeRequest> createRepeated() =>
      $pb.PbList<ProfileSpriteChangeRequest>();
  @$core.pragma('dart2js:noInline')
  static ProfileSpriteChangeRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProfileSpriteChangeRequest>(create);
...
class ProfileStatusTextUpdateRequest extends $pb.GeneratedMessage {
  ...
  factory ProfileStatusTextUpdateRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ProfileStatusTextUpdateRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ProfileStatusTextUpdateRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ProfileStatusTextUpdateRequest clone() =>
      ProfileStatusTextUpdateRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ProfileStatusTextUpdateRequest copyWith(
          void Function(ProfileStatusTextUpdateRequest) updates) =>
      super.copyWith(
              (message) => updates(message as ProfileStatusTextUpdateRequest))
          as ProfileStatusTextUpdateRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ProfileStatusTextUpdateRequest create() =>
      ProfileStatusTextUpdateRequest._();
  ProfileStatusTextUpdateRequest createEmptyInstance() => create();
  static $pb.PbList<ProfileStatusTextUpdateRequest> createRepeated() =>
      $pb.PbList<ProfileStatusTextUpdateRequest>();
  @$core.pragma('dart2js:noInline')
  static ProfileStatusTextUpdateRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProfileStatusTextUpdateRequest>(create);
...
class ProfileDisplayNameUpdateRequest extends $pb.GeneratedMessage {
  ...
  factory ProfileDisplayNameUpdateRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ProfileDisplayNameUpdateRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ProfileDisplayNameUpdateRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ProfileDisplayNameUpdateRequest clone() =>
      ProfileDisplayNameUpdateRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ProfileDisplayNameUpdateRequest copyWith(
          void Function(ProfileDisplayNameUpdateRequest) updates) =>
      super.copyWith(
              (message) => updates(message as ProfileDisplayNameUpdateRequest))
          as ProfileDisplayNameUpdateRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ProfileDisplayNameUpdateRequest create() =>
      ProfileDisplayNameUpdateRequest._();
  ProfileDisplayNameUpdateRequest createEmptyInstance() => create();
  static $pb.PbList<ProfileDisplayNameUpdateRequest> createRepeated() =>
      $pb.PbList<ProfileDisplayNameUpdateRequest>();
  @$core.pragma('dart2js:noInline')
  static ProfileDisplayNameUpdateRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProfileDisplayNameUpdateRequest>(
          create);
...
class ProfileSteamBindRequest extends $pb.GeneratedMessage {
  ...
  factory ProfileSteamBindRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ProfileSteamBindRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ProfileSteamBindRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ProfileSteamBindRequest clone() =>
      ProfileSteamBindRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ProfileSteamBindRequest copyWith(
          void Function(ProfileSteamBindRequest) updates) =>
      super.copyWith((message) => updates(message as ProfileSteamBindRequest))
          as ProfileSteamBindRequest;
  ...
  static $pb.PbList<ProfileSteamBindRequest> createRepeated() =>
      $pb.PbList<ProfileSteamBindRequest>();
  @$core.pragma('dart2js:noInline')
  static ProfileSteamBindRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProfileSteamBindRequest>(create);
...
class SnapshotRequest extends $pb.GeneratedMessage {
  factory SnapshotRequest({
    $fixnum.Int64? lastDeltaSeq,
  }) {
    final $result = create();
    if (lastDeltaSeq != null) {
      $result.lastDeltaSeq = lastDeltaSeq;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'lastDeltaSeq')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $fixnum.Int64 get lastDeltaSeq => $_getI64(0);
  @$pb.TagNumber(1)
  set lastDeltaSeq($fixnum.Int64 v) {
    $_setInt64(0, v);
  }

  @$pb.TagNumber(1)
  $core.bool hasLastDeltaSeq() => $_has(0);
  @$pb.TagNumber(1)
  void clearLastDeltaSeq() => clearField(1);
}
...
class BroadcastSendRequest extends $pb.GeneratedMessage {
  ...
  factory BroadcastSendRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BroadcastSendRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BroadcastSendRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'content')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BroadcastSendRequest clone() =>
      BroadcastSendRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BroadcastSendRequest copyWith(void Function(BroadcastSendRequest) updates) =>
      super.copyWith((message) => updates(message as BroadcastSendRequest))
          as BroadcastSendRequest;
  ...
  static $pb.PbList<BroadcastSendRequest> createRepeated() =>
      $pb.PbList<BroadcastSendRequest>();
  @$core.pragma('dart2js:noInline')
  static BroadcastSendRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BroadcastSendRequest>(create);
...
class BroadcastCDRequest extends $pb.GeneratedMessage {
  ...
  factory BroadcastCDRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BroadcastCDRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BroadcastCDRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BroadcastCDRequest copyWith(void Function(BroadcastCDRequest) updates) =>
      super.copyWith((message) => updates(message as BroadcastCDRequest))
          as BroadcastCDRequest;
  ...
  static $pb.PbList<BroadcastCDRequest> createRepeated() =>
      $pb.PbList<BroadcastCDRequest>();
  @$core.pragma('dart2js:noInline')
  static BroadcastCDRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BroadcastCDRequest>(create);
...
class PortalUseRequest extends $pb.GeneratedMessage {
  ...
  factory PortalUseRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PortalUseRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PortalUseRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PortalUseRequest copyWith(void Function(PortalUseRequest) updates) =>
      super.copyWith((message) => updates(message as PortalUseRequest))
          as PortalUseRequest;
  ...
  static $pb.PbList<PortalUseRequest> createRepeated() =>
      $pb.PbList<PortalUseRequest>();
  @$core.pragma('dart2js:noInline')
  static PortalUseRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PortalUseRequest>(create);
  static PortalUseRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get portalKey => $_getSZ(0);
  @$pb.TagNumber(1)
  set portalKey($core.String v) {
    $_setString(0, v);
  }
...
class OnlineStatsRequest extends $pb.GeneratedMessage {
  ...
  factory OnlineStatsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory OnlineStatsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'OnlineStatsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  OnlineStatsRequest copyWith(void Function(OnlineStatsRequest) updates) =>
      super.copyWith((message) => updates(message as OnlineStatsRequest))
          as OnlineStatsRequest;
  ...
  static $pb.PbList<OnlineStatsRequest> createRepeated() =>
      $pb.PbList<OnlineStatsRequest>();
  @$core.pragma('dart2js:noInline')
  static OnlineStatsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OnlineStatsRequest>(create);
  static OnlineStatsRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get includeUsers => $_getBF(0);
  @$pb.TagNumber(1)
  set includeUsers($core.bool v) {
    $_setBool(0, v);
  }
...
class LoginSuccessResponse extends $pb.GeneratedMessage {
  ...
  factory LoginSuccessResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LoginSuccessResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LoginSuccessResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..aOS(2, _omitFieldNames ? '' : 'nickname')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  LoginSuccessResponse clone() =>
      LoginSuccessResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LoginSuccessResponse copyWith(void Function(LoginSuccessResponse) updates) =>
      super.copyWith((message) => updates(message as LoginSuccessResponse))
  ...
  static $pb.PbList<LoginSuccessResponse> createRepeated() =>
      $pb.PbList<LoginSuccessResponse>();
  @$core.pragma('dart2js:noInline')
  static LoginSuccessResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LoginSuccessResponse>(create);
...
class LoginFailedResponse extends $pb.GeneratedMessage {
  ...
  factory LoginFailedResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LoginFailedResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LoginFailedResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LoginFailedResponse copyWith(void Function(LoginFailedResponse) updates) =>
      super.copyWith((message) => updates(message as LoginFailedResponse))
  ...
  static $pb.PbList<LoginFailedResponse> createRepeated() =>
      $pb.PbList<LoginFailedResponse>();
  @$core.pragma('dart2js:noInline')
  static LoginFailedResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LoginFailedResponse>(create);
...
class LogoutSuccessResponse extends $pb.GeneratedMessage {
  ...
  factory LogoutSuccessResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LogoutSuccessResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LogoutSuccessResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  LogoutSuccessResponse clone() =>
      LogoutSuccessResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LogoutSuccessResponse copyWith(
          void Function(LogoutSuccessResponse) updates) =>
      super.copyWith((message) => updates(message as LogoutSuccessResponse))
  ...
  static $pb.PbList<LogoutSuccessResponse> createRepeated() =>
      $pb.PbList<LogoutSuccessResponse>();
  @$core.pragma('dart2js:noInline')
  static LogoutSuccessResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LogoutSuccessResponse>(create);
  static LogoutSuccessResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get kick => $_getBF(0);
  @$pb.TagNumber(1)
  set kick($core.bool v) {
    $_setBool(0, v);
  }
...
class JoinSuccessResponse extends $pb.GeneratedMessage {
  ...
  factory JoinSuccessResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory JoinSuccessResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'JoinSuccessResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'mapId')
    ..aOM<LobbyUser>(2, _omitFieldNames ? '' : 'user',
        subBuilder: LobbyUser.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  JoinSuccessResponse copyWith(void Function(JoinSuccessResponse) updates) =>
      super.copyWith((message) => updates(message as JoinSuccessResponse))
          as JoinSuccessResponse;
  ...
  static $pb.PbList<JoinSuccessResponse> createRepeated() =>
      $pb.PbList<JoinSuccessResponse>();
  @$core.pragma('dart2js:noInline')
  static JoinSuccessResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<JoinSuccessResponse>(create);
...
class SnapshotResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOM<LobbyMapConfig>(1, _omitFieldNames ? '' : 'mapConfig',
        subBuilder: LobbyMapConfig.create)
    ..aOM<LobbyUser>(2, _omitFieldNames ? '' : 'self',
        subBuilder: LobbyUser.create)
    ..pc<LobbyUser>(3, _omitFieldNames ? '' : 'users', $pb.PbFieldType.PM,
        subBuilder: LobbyUser.create)
    ..pc<LobbyMessage>(
        4, _omitFieldNames ? '' : 'recentMessages', $pb.PbFieldType.PM,
        subBuilder: LobbyMessage.create)
    ..aOM<PageInfo>(5, _omitFieldNames ? '' : 'pageInfo',
        subBuilder: PageInfo.create)
    ..aOB(6, _omitFieldNames ? '' : 'isResume')
    ..pPS(7, _omitFieldNames ? '' : 'leftUserIds')
    ..aInt64(8, _omitFieldNames ? '' : 'deltaSeq')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set mapConfig(LobbyMapConfig v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(6)
  $core.bool get isResume => $_getBF(5);
  @$pb.TagNumber(6)
  set isResume($core.bool v) {
    $_setBool(5, v);
  }

  @$pb.TagNumber(6)
  $core.bool hasIsResume() => $_has(5);
  @$pb.TagNumber(6)
  void clearIsResume() => clearField(6);

  @$pb.TagNumber(7)
  $core.List<$core.String> get leftUserIds => $_getList(6);

  @$pb.TagNumber(8)
  $fixnum.Int64 get deltaSeq => $_getI64(7);
  @$pb.TagNumber(8)
  set deltaSeq($fixnum.Int64 v) {
    $_setInt64(7, v);
  }

  @$pb.TagNumber(8)
  $core.bool hasDeltaSeq() => $_has(7);
  @$pb.TagNumber(8)
  void clearDeltaSeq() => clearField(8);
}
...
class PresenceJoinResponse extends $pb.GeneratedMessage {
  ...
  factory PresenceJoinResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PresenceJoinResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PresenceJoinResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOM<LobbyUser>(1, _omitFieldNames ? '' : 'user',
        subBuilder: LobbyUser.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PresenceJoinResponse clone() =>
      PresenceJoinResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PresenceJoinResponse copyWith(void Function(PresenceJoinResponse) updates) =>
      super.copyWith((message) => updates(message as PresenceJoinResponse))
          as PresenceJoinResponse;
  ...
  static $pb.PbList<PresenceJoinResponse> createRepeated() =>
      $pb.PbList<PresenceJoinResponse>();
  @$core.pragma('dart2js:noInline')
  static PresenceJoinResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PresenceJoinResponse>(create);
  ...
  @$pb.TagNumber(3)
  set isCrossMapNotification($core.bool v) {
    $_setBool(2, v);
  }
...
class PresenceLeaveResponse extends $pb.GeneratedMessage {
  ...
  factory PresenceLeaveResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PresenceLeaveResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PresenceLeaveResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PresenceLeaveResponse clone() =>
      PresenceLeaveResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PresenceLeaveResponse copyWith(
          void Function(PresenceLeaveResponse) updates) =>
      super.copyWith((message) => updates(message as PresenceLeaveResponse))
          as PresenceLeaveResponse;
  ...
  static $pb.PbList<PresenceLeaveResponse> createRepeated() =>
      $pb.PbList<PresenceLeaveResponse>();
  @$core.pragma('dart2js:noInline')
  static PresenceLeaveResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PresenceLeaveResponse>(create);
...
class IdentityChangedResponse extends $pb.GeneratedMessage {
  ...
  factory IdentityChangedResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory IdentityChangedResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'IdentityChangedResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  IdentityChangedResponse clone() =>
      IdentityChangedResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  IdentityChangedResponse copyWith(
          void Function(IdentityChangedResponse) updates) =>
      super.copyWith((message) => updates(message as IdentityChangedResponse))
          as IdentityChangedResponse;
  ...
  static $pb.PbList<IdentityChangedResponse> createRepeated() =>
      $pb.PbList<IdentityChangedResponse>();
  @$core.pragma('dart2js:noInline')
  static IdentityChangedResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<IdentityChangedResponse>(create);
...
class MoveBroadcastResponse extends $pb.GeneratedMessage {
  ...
  factory MoveBroadcastResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MoveBroadcastResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MoveBroadcastResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  MoveBroadcastResponse clone() =>
      MoveBroadcastResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  MoveBroadcastResponse copyWith(
          void Function(MoveBroadcastResponse) updates) =>
      super.copyWith((message) => updates(message as MoveBroadcastResponse))
          as MoveBroadcastResponse;
  ...
  static $pb.PbList<MoveBroadcastResponse> createRepeated() =>
      $pb.PbList<MoveBroadcastResponse>();
  @$core.pragma('dart2js:noInline')
  static MoveBroadcastResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MoveBroadcastResponse>(create);
...
class MoveRejectResponse extends $pb.GeneratedMessage {
  ...
  factory MoveRejectResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MoveRejectResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MoveRejectResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'reason')
    ..a<$core.double>(
        2, _omitFieldNames ? '' : 'correctionX', $pb.PbFieldType.OD)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'correctionY', $pb.PbFieldType.OD)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  MoveRejectResponse copyWith(void Function(MoveRejectResponse) updates) =>
      super.copyWith((message) => updates(message as MoveRejectResponse))
          as MoveRejectResponse;
  ...
  static $pb.PbList<MoveRejectResponse> createRepeated() =>
      $pb.PbList<MoveRejectResponse>();
  @$core.pragma('dart2js:noInline')
  static MoveRejectResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MoveRejectResponse>(create);
...
class ChatMessageResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOM<LobbyMessage>(1, _omitFieldNames ? '' : 'message',
        subBuilder: LobbyMessage.create)
    ..hasRequiredFields = false;
...
class ChatRejectResponse extends $pb.GeneratedMessage {
  ...
  factory ChatRejectResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ChatRejectResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ChatRejectResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'reason')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ChatRejectResponse copyWith(void Function(ChatRejectResponse) updates) =>
      super.copyWith((message) => updates(message as ChatRejectResponse))
          as ChatRejectResponse;
  ...
  static $pb.PbList<ChatRejectResponse> createRepeated() =>
      $pb.PbList<ChatRejectResponse>();
  @$core.pragma('dart2js:noInline')
  static ChatRejectResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ChatRejectResponse>(create);
...
class AnonymousChangedResponse extends $pb.GeneratedMessage {
  ...
  factory AnonymousChangedResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AnonymousChangedResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AnonymousChangedResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  AnonymousChangedResponse clone() =>
      AnonymousChangedResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AnonymousChangedResponse copyWith(
          void Function(AnonymousChangedResponse) updates) =>
      super.copyWith((message) => updates(message as AnonymousChangedResponse))
          as AnonymousChangedResponse;
  ...
  static $pb.PbList<AnonymousChangedResponse> createRepeated() =>
      $pb.PbList<AnonymousChangedResponse>();
  @$core.pragma('dart2js:noInline')
  static AnonymousChangedResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AnonymousChangedResponse>(create);
  ...
  @$pb.TagNumber(3)
  set displayNickname($core.String v) {
    $_setString(2, v);
  }
...
class SpriteChangedResponse extends $pb.GeneratedMessage {
  ...
  factory SpriteChangedResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SpriteChangedResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SpriteChangedResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SpriteChangedResponse clone() =>
      SpriteChangedResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SpriteChangedResponse copyWith(
          void Function(SpriteChangedResponse) updates) =>
      super.copyWith((message) => updates(message as SpriteChangedResponse))
          as SpriteChangedResponse;
  ...
  static $pb.PbList<SpriteChangedResponse> createRepeated() =>
      $pb.PbList<SpriteChangedResponse>();
  @$core.pragma('dart2js:noInline')
  static SpriteChangedResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SpriteChangedResponse>(create);
...
class SpriteChangeSuccessResponse extends $pb.GeneratedMessage {
  ...
  factory SpriteChangeSuccessResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SpriteChangeSuccessResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SpriteChangeSuccessResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'spriteId')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SpriteChangeSuccessResponse clone() =>
      SpriteChangeSuccessResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SpriteChangeSuccessResponse copyWith(
          void Function(SpriteChangeSuccessResponse) updates) =>
      super.copyWith(
              (message) => updates(message as SpriteChangeSuccessResponse))
          as SpriteChangeSuccessResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SpriteChangeSuccessResponse create() =>
      SpriteChangeSuccessResponse._();
  SpriteChangeSuccessResponse createEmptyInstance() => create();
  static $pb.PbList<SpriteChangeSuccessResponse> createRepeated() =>
      $pb.PbList<SpriteChangeSuccessResponse>();
  @$core.pragma('dart2js:noInline')
  static SpriteChangeSuccessResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SpriteChangeSuccessResponse>(create);
...
class SpriteChangeRejectResponse extends $pb.GeneratedMessage {
  ...
  factory SpriteChangeRejectResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SpriteChangeRejectResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SpriteChangeRejectResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'reason')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SpriteChangeRejectResponse clone() =>
      SpriteChangeRejectResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SpriteChangeRejectResponse copyWith(
          void Function(SpriteChangeRejectResponse) updates) =>
      super.copyWith(
              (message) => updates(message as SpriteChangeRejectResponse))
          as SpriteChangeRejectResponse;
  ...
  static $pb.PbList<SpriteChangeRejectResponse> createRepeated() =>
      $pb.PbList<SpriteChangeRejectResponse>();
  @$core.pragma('dart2js:noInline')
  static SpriteChangeRejectResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SpriteChangeRejectResponse>(create);
...
class StatusTextBroadcastResponse extends $pb.GeneratedMessage {
  ...
  factory StatusTextBroadcastResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory StatusTextBroadcastResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'StatusTextBroadcastResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  StatusTextBroadcastResponse clone() =>
      StatusTextBroadcastResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  StatusTextBroadcastResponse copyWith(
          void Function(StatusTextBroadcastResponse) updates) =>
      super.copyWith(
              (message) => updates(message as StatusTextBroadcastResponse))
          as StatusTextBroadcastResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static StatusTextBroadcastResponse create() =>
      StatusTextBroadcastResponse._();
  StatusTextBroadcastResponse createEmptyInstance() => create();
  static $pb.PbList<StatusTextBroadcastResponse> createRepeated() =>
      $pb.PbList<StatusTextBroadcastResponse>();
  @$core.pragma('dart2js:noInline')
  static StatusTextBroadcastResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<StatusTextBroadcastResponse>(create);
...
class DisplayNameChangedResponse extends $pb.GeneratedMessage {
  ...
  factory DisplayNameChangedResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DisplayNameChangedResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DisplayNameChangedResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..aOS(2, _omitFieldNames ? '' : 'nickname')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  DisplayNameChangedResponse clone() =>
      DisplayNameChangedResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  DisplayNameChangedResponse copyWith(
          void Function(DisplayNameChangedResponse) updates) =>
      super.copyWith(
              (message) => updates(message as DisplayNameChangedResponse))
          as DisplayNameChangedResponse;
  ...
  static $pb.PbList<DisplayNameChangedResponse> createRepeated() =>
      $pb.PbList<DisplayNameChangedResponse>();
  @$core.pragma('dart2js:noInline')
  static DisplayNameChangedResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DisplayNameChangedResponse>(create);
...
class AssetsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..pc<LobbyMapConfig>(1, _omitFieldNames ? '' : 'maps', $pb.PbFieldType.PM,
        subBuilder: LobbyMapConfig.create)
    ..pc<LobbySpriteConfig>(
        2, _omitFieldNames ? '' : 'sprites', $pb.PbFieldType.PM,
        subBuilder: LobbySpriteConfig.create)
    ..hasRequiredFields = false;
...
class AssetsUpdatedResponse extends $pb.GeneratedMessage {
  ...
  factory AssetsUpdatedResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AssetsUpdatedResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AssetsUpdatedResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  AssetsUpdatedResponse clone() =>
      AssetsUpdatedResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AssetsUpdatedResponse copyWith(
          void Function(AssetsUpdatedResponse) updates) =>
      super.copyWith((message) => updates(message as AssetsUpdatedResponse))
          as AssetsUpdatedResponse;
  ...
  static $pb.PbList<AssetsUpdatedResponse> createRepeated() =>
      $pb.PbList<AssetsUpdatedResponse>();
  @$core.pragma('dart2js:noInline')
  static AssetsUpdatedResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AssetsUpdatedResponse>(create);
...
class PortalTeleportResponse extends $pb.GeneratedMessage {
  ...
  factory PortalTeleportResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PortalTeleportResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PortalTeleportResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'portalKey')
    ..aOS(2, _omitFieldNames ? '' : 'label')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PortalTeleportResponse clone() =>
      PortalTeleportResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PortalTeleportResponse copyWith(
          void Function(PortalTeleportResponse) updates) =>
      super.copyWith((message) => updates(message as PortalTeleportResponse))
          as PortalTeleportResponse;
  ...
  static $pb.PbList<PortalTeleportResponse> createRepeated() =>
      $pb.PbList<PortalTeleportResponse>();
  @$core.pragma('dart2js:noInline')
  static PortalTeleportResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PortalTeleportResponse>(create);
  ...
  @$pb.TagNumber(7)
  set targetMatchId($core.String v) {
    $_setString(6, v);
  }
...
class PortalUseRejectResponse extends $pb.GeneratedMessage {
  ...
  factory PortalUseRejectResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PortalUseRejectResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PortalUseRejectResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'reason')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PortalUseRejectResponse clone() =>
      PortalUseRejectResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PortalUseRejectResponse copyWith(
          void Function(PortalUseRejectResponse) updates) =>
      super.copyWith((message) => updates(message as PortalUseRejectResponse))
          as PortalUseRejectResponse;
  ...
  static $pb.PbList<PortalUseRejectResponse> createRepeated() =>
      $pb.PbList<PortalUseRejectResponse>();
  @$core.pragma('dart2js:noInline')
  static PortalUseRejectResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PortalUseRejectResponse>(create);
...
class BroadcastMessageResponse extends $pb.GeneratedMessage {
  ...
  factory BroadcastMessageResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BroadcastMessageResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BroadcastMessageResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOM<LobbyBroadcastMessage>(1, _omitFieldNames ? '' : 'message',
        subBuilder: LobbyBroadcastMessage.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BroadcastMessageResponse clone() =>
      BroadcastMessageResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BroadcastMessageResponse copyWith(
          void Function(BroadcastMessageResponse) updates) =>
      super.copyWith((message) => updates(message as BroadcastMessageResponse))
  ...
  static $pb.PbList<BroadcastMessageResponse> createRepeated() =>
      $pb.PbList<BroadcastMessageResponse>();
  @$core.pragma('dart2js:noInline')
  static BroadcastMessageResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BroadcastMessageResponse>(create);
  static BroadcastMessageResponse? _defaultInstance;

  @$pb.TagNumber(1)
  LobbyBroadcastMessage get message => $_getN(0);
  @$pb.TagNumber(1)
  set message(LobbyBroadcastMessage v) {
    setField(1, v);
  }
...
class BroadcastRejectResponse extends $pb.GeneratedMessage {
  ...
  factory BroadcastRejectResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BroadcastRejectResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BroadcastRejectResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'reason')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BroadcastRejectResponse clone() =>
      BroadcastRejectResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BroadcastRejectResponse copyWith(
          void Function(BroadcastRejectResponse) updates) =>
      super.copyWith((message) => updates(message as BroadcastRejectResponse))
          as BroadcastRejectResponse;
  ...
  static $pb.PbList<BroadcastRejectResponse> createRepeated() =>
      $pb.PbList<BroadcastRejectResponse>();
  @$core.pragma('dart2js:noInline')
  static BroadcastRejectResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BroadcastRejectResponse>(create);
...
class BroadcastCDResponse extends $pb.GeneratedMessage {
  ...
  factory BroadcastCDResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BroadcastCDResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BroadcastCDResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BroadcastCDResponse copyWith(void Function(BroadcastCDResponse) updates) =>
      super.copyWith((message) => updates(message as BroadcastCDResponse))
          as BroadcastCDResponse;
  ...
  static $pb.PbList<BroadcastCDResponse> createRepeated() =>
      $pb.PbList<BroadcastCDResponse>();
  @$core.pragma('dart2js:noInline')
  static BroadcastCDResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BroadcastCDResponse>(create);
  static BroadcastCDResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get inCooldown => $_getBF(0);
  @$pb.TagNumber(1)
  set inCooldown($core.bool v) {
    $_setBool(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set remainingMs($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set nextBroadcastAt($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
...
class OnlineStatsResponse extends $pb.GeneratedMessage {
  ...
  factory OnlineStatsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory OnlineStatsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'OnlineStatsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'total', $pb.PbFieldType.O3)
    ..m<$core.String, $core.int>(2, _omitFieldNames ? '' : 'byMap',
        entryClassName: 'OnlineStatsResponse.ByMapEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.O3,
        packageName: const $pb.PackageName('lobby'))
    ..pc<LobbyUser>(3, _omitFieldNames ? '' : 'users', $pb.PbFieldType.PM,
        subBuilder: LobbyUser.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  OnlineStatsResponse copyWith(void Function(OnlineStatsResponse) updates) =>
      super.copyWith((message) => updates(message as OnlineStatsResponse))
          as OnlineStatsResponse;
  ...
  static $pb.PbList<OnlineStatsResponse> createRepeated() =>
      $pb.PbList<OnlineStatsResponse>();
  @$core.pragma('dart2js:noInline')
  static OnlineStatsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OnlineStatsResponse>(create);
...
class SystemErrorResponse extends $pb.GeneratedMessage {
  ...
  factory SystemErrorResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SystemErrorResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SystemErrorResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'code', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'message')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SystemErrorResponse copyWith(void Function(SystemErrorResponse) updates) =>
      super.copyWith((message) => updates(message as SystemErrorResponse))
          as SystemErrorResponse;
  ...
  static $pb.PbList<SystemErrorResponse> createRepeated() =>
      $pb.PbList<SystemErrorResponse>();
  @$core.pragma('dart2js:noInline')
  static SystemErrorResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SystemErrorResponse>(create);
...
class SystemNoticeResponse extends $pb.GeneratedMessage {
  ...
  factory SystemNoticeResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SystemNoticeResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SystemNoticeResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SystemNoticeResponse clone() =>
      SystemNoticeResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SystemNoticeResponse copyWith(void Function(SystemNoticeResponse) updates) =>
      super.copyWith((message) => updates(message as SystemNoticeResponse))
          as SystemNoticeResponse;
  ...
  static $pb.PbList<SystemNoticeResponse> createRepeated() =>
      $pb.PbList<SystemNoticeResponse>();
  @$core.pragma('dart2js:noInline')
  static SystemNoticeResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SystemNoticeResponse>(create);
...
class SystemKickedResponse extends $pb.GeneratedMessage {
  ...
  factory SystemKickedResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SystemKickedResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SystemKickedResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'reason')
    ..aOS(2, _omitFieldNames ? '' : 'message')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SystemKickedResponse clone() =>
      SystemKickedResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SystemKickedResponse copyWith(void Function(SystemKickedResponse) updates) =>
      super.copyWith((message) => updates(message as SystemKickedResponse))
          as SystemKickedResponse;
  ...
  static $pb.PbList<SystemKickedResponse> createRepeated() =>
      $pb.PbList<SystemKickedResponse>();
  @$core.pragma('dart2js:noInline')
  static SystemKickedResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SystemKickedResponse>(create);
...
class SteamBindSuccessResponse extends $pb.GeneratedMessage {
  ...
  factory SteamBindSuccessResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SteamBindSuccessResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SteamBindSuccessResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'steamId')
    ..aOS(2, _omitFieldNames ? '' : 'steamName')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SteamBindSuccessResponse clone() =>
      SteamBindSuccessResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SteamBindSuccessResponse copyWith(
          void Function(SteamBindSuccessResponse) updates) =>
      super.copyWith((message) => updates(message as SteamBindSuccessResponse))
          as SteamBindSuccessResponse;
  ...
  static $pb.PbList<SteamBindSuccessResponse> createRepeated() =>
      $pb.PbList<SteamBindSuccessResponse>();
  @$core.pragma('dart2js:noInline')
  static SteamBindSuccessResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SteamBindSuccessResponse>(create);
...
class LobbyJoinRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LobbyJoinRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'deviceType')
    ..a<$core.int>(
        2, _omitFieldNames ? '' : 'protocolFeatures', $pb.PbFieldType.O3)
  ...
  static $pb.PbList<LobbyJoinRequest> createRepeated() =>
      $pb.PbList<LobbyJoinRequest>();
  @$core.pragma('dart2js:noInline')
  static LobbyJoinRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LobbyJoinRequest>(create);
...
class LobbyJoinResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LobbyJoinResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ...
    ..a<$core.int>(
        7, _omitFieldNames ? '' : 'pollIntervalMs', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;
  ...
  static $pb.PbList<LobbyJoinResponse> createRepeated() =>
      $pb.PbList<LobbyJoinResponse>();
  @$core.pragma('dart2js:noInline')
  static LobbyJoinResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LobbyJoinResponse>(create);
...
class SteamUserInfoRequest extends $pb.GeneratedMessage {
  ...
  factory SteamUserInfoRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SteamUserInfoRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SteamUserInfoRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SteamUserInfoRequest clone() =>
      SteamUserInfoRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SteamUserInfoRequest copyWith(void Function(SteamUserInfoRequest) updates) =>
      super.copyWith((message) => updates(message as SteamUserInfoRequest))
          as SteamUserInfoRequest;
  ...
  static $pb.PbList<SteamUserInfoRequest> createRepeated() =>
      $pb.PbList<SteamUserInfoRequest>();
  @$core.pragma('dart2js:noInline')
  static SteamUserInfoRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SteamUserInfoRequest>(create);
...
class SteamUserInfoResponse extends $pb.GeneratedMessage {
  ...
  factory SteamUserInfoResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SteamUserInfoResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SteamUserInfoResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'code', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'message')
    ...
    ..a<$core.int>(
        60, _omitFieldNames ? '' : 'donatorLevel', $pb.PbFieldType.O3)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SteamUserInfoResponse clone() =>
      SteamUserInfoResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SteamUserInfoResponse copyWith(
          void Function(SteamUserInfoResponse) updates) =>
      super.copyWith((message) => updates(message as SteamUserInfoResponse))
          as SteamUserInfoResponse;
  ...
  static $pb.PbList<SteamUserInfoResponse> createRepeated() =>
      $pb.PbList<SteamUserInfoResponse>();
  @$core.pragma('dart2js:noInline')
  static SteamUserInfoResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SteamUserInfoResponse>(create);
  ...
  @$pb.TagNumber(4)
  set forumUsername($core.String v) {
    $_setString(3, v);
  }
  ...
  @$pb.TagNumber(5)
  set forumAvatarUrl($core.String v) {
    $_setString(4, v);
  }
  ...
  @$pb.TagNumber(16)
  set onlineTimeTotal($fixnum.Int64 v) {
    $_setInt64(15, v);
  }
  ...
  @$pb.TagNumber(17)
  set onlineTimeDay($fixnum.Int64 v) {
    $_setInt64(16, v);
  }
  ...
  @$pb.TagNumber(20)
  set cs2SpentPoint($fixnum.Int64 v) {
    $_setInt64(19, v);
  }
  ...
  @$pb.TagNumber(25)
  set surfPtsRank($fixnum.Int64 v) {
    $_setInt64(24, v);
  }
  ...
  @$pb.TagNumber(26)
  set surfPtsTotal($fixnum.Int64 v) {
    $_setInt64(25, v);
  }
  ...
  @$pb.TagNumber(28)
  set bhopPtsRank($fixnum.Int64 v) {
    $_setInt64(27, v);
  }
  ...
  @$pb.TagNumber(29)
  set bhopPtsTotal($fixnum.Int64 v) {
    $_setInt64(28, v);
  }
  ...
  @$pb.TagNumber(33)
  set csgoOnlineTime($fixnum.Int64 v) {
    $_setInt64(32, v);
  }
  ...
  @$pb.TagNumber(34)
  set csgoZombiePts($fixnum.Int64 v) {
    $_setInt64(33, v);
  }
  ...
  @$pb.TagNumber(35)
  set csgoZombieKill($fixnum.Int64 v) {
    $_setInt64(34, v);
  }
  ...
  @$pb.TagNumber(36)
  set csgoZombieKnife($fixnum.Int64 v) {
    $_setInt64(35, v);
  }
  ...
  @$pb.TagNumber(37)
  set csgoZombieKickAss($fixnum.Int64 v) {
    $_setInt64(36, v);
  }
  ...
  @$pb.TagNumber(38)
  set csgoZombieLostAss($fixnum.Int64 v) {
    $_setInt64(37, v);
  }
  ...
  @$pb.TagNumber(39)
  set csgoZombieProLevel($fixnum.Int64 v) {
    $_setInt64(38, v);
  }
  ...
  @$pb.TagNumber(41)
  set csgoSurfPts($fixnum.Int64 v) {
    $_setInt64(40, v);
  }
  ...
  @$pb.TagNumber(42)
  set csgoBhopPts($fixnum.Int64 v) {
    $_setInt64(41, v);
  }
  ...
  @$pb.TagNumber(44)
  set csgoTttInnocentPts($fixnum.Int64 v) {
    $_setInt64(43, v);
  }
  ...
  @$pb.TagNumber(45)
  set csgoTttDetectivePts($fixnum.Int64 v) {
    $_setInt64(44, v);
  }
  ...
  @$pb.TagNumber(46)
  set csgoTttTraitorPts($fixnum.Int64 v) {
    $_setInt64(45, v);
  }
  ...
  @$pb.TagNumber(47)
  set cssZombiePts($fixnum.Int64 v) {
    $_setInt64(46, v);
  }
  ...
  @$pb.TagNumber(48)
  set cssZombieKill($fixnum.Int64 v) {
    $_setInt64(47, v);
  }
  ...
  @$pb.TagNumber(49)
  set cssZombieKnife($fixnum.Int64 v) {
    $_setInt64(48, v);
  }
  ...
  @$pb.TagNumber(50)
  set cssZombieKickAss($fixnum.Int64 v) {
    $_setInt64(49, v);
  }
  ...
  @$pb.TagNumber(51)
  set cssZombieProLevel($fixnum.Int64 v) {
    $_setInt64(50, v);
  }
  ...
  @$pb.TagNumber(52)
  set cssTitanPts($fixnum.Int64 v) {
    $_setInt64(51, v);
  }
  ...
  @$pb.TagNumber(53)
  set cssTitanKills($fixnum.Int64 v) {
    $_setInt64(52, v);
  }
  ...
  @$pb.TagNumber(54)
  set cssTitanSpecialKills($fixnum.Int64 v) {
    $_setInt64(53, v);
  }
  ...
  @$pb.TagNumber(55)
  set cssTitanHumanKills($fixnum.Int64 v) {
    $_setInt64(54, v);
  }
  ...
  @$pb.TagNumber(56)
  set cssTitanAssists($fixnum.Int64 v) {
    $_setInt64(55, v);
  }
  ...
  @$pb.TagNumber(58)
  set cssTttWrongKill($fixnum.Int64 v) {
    $_setInt64(57, v);
  }
  ...
  @$pb.TagNumber(59)
  set cssTttKarma($fixnum.Int64 v) {
    $_setInt64(58, v);
  }
  ...
  @$pb.TagNumber(63)
  set donatorSignToday($core.bool v) {
    $_setBool(62, v);
  }
...
class InventoryStatsRequest extends $pb.GeneratedMessage {
  ...
  factory InventoryStatsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InventoryStatsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InventoryStatsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  InventoryStatsRequest clone() =>
      InventoryStatsRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  InventoryStatsRequest copyWith(
          void Function(InventoryStatsRequest) updates) =>
      super.copyWith((message) => updates(message as InventoryStatsRequest))
          as InventoryStatsRequest;
  ...
  static $pb.PbList<InventoryStatsRequest> createRepeated() =>
      $pb.PbList<InventoryStatsRequest>();
  @$core.pragma('dart2js:noInline')
  static InventoryStatsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InventoryStatsRequest>(create);
...
class InventoryStatsResponse extends $pb.GeneratedMessage {
  ...
  factory InventoryStatsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InventoryStatsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InventoryStatsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'code', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'message')
    ...
    ..a<$core.int>(
        10, _omitFieldNames ? '' : 'skinmenuCount', $pb.PbFieldType.O3)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  InventoryStatsResponse clone() =>
      InventoryStatsResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  InventoryStatsResponse copyWith(
          void Function(InventoryStatsResponse) updates) =>
      super.copyWith((message) => updates(message as InventoryStatsResponse))
          as InventoryStatsResponse;
  ...
  static $pb.PbList<InventoryStatsResponse> createRepeated() =>
      $pb.PbList<InventoryStatsResponse>();
  @$core.pragma('dart2js:noInline')
  static InventoryStatsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InventoryStatsResponse>(create);
  ...
  @$pb.TagNumber(11)
  set totalGoldValue($fixnum.Int64 v) {
    $_setInt64(10, v);
  }
  ...
  @$pb.TagNumber(12)
  set totalPointValue($fixnum.Int64 v) {
    $_setInt64(11, v);
  }
...
class PresenceDeltaResponse extends $pb.GeneratedMessage {
  ...
  factory PresenceDeltaResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PresenceDeltaResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PresenceDeltaResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..pc<LobbyUser>(1, _omitFieldNames ? '' : 'joined', $pb.PbFieldType.PM,
        subBuilder: LobbyUser.create)
    ..pPS(2, _omitFieldNames ? '' : 'leftUserIds')
    ..pc<CrossMapPresenceEvent>(
        3, _omitFieldNames ? '' : 'crossMapEvents', $pb.PbFieldType.PM,
        subBuilder: CrossMapPresenceEvent.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PresenceDeltaResponse clone() =>
      PresenceDeltaResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PresenceDeltaResponse copyWith(
          void Function(PresenceDeltaResponse) updates) =>
      super.copyWith((message) => updates(message as PresenceDeltaResponse))
          as PresenceDeltaResponse;
  ...
  static $pb.PbList<PresenceDeltaResponse> createRepeated() =>
      $pb.PbList<PresenceDeltaResponse>();
  @$core.pragma('dart2js:noInline')
  static PresenceDeltaResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PresenceDeltaResponse>(create);
...
class CrossMapPresenceEvent extends $pb.GeneratedMessage {
  ...
  factory CrossMapPresenceEvent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CrossMapPresenceEvent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CrossMapPresenceEvent',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..aOS(2, _omitFieldNames ? '' : 'nickname')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  CrossMapPresenceEvent clone() =>
      CrossMapPresenceEvent()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CrossMapPresenceEvent copyWith(
          void Function(CrossMapPresenceEvent) updates) =>
      super.copyWith((message) => updates(message as CrossMapPresenceEvent))
          as CrossMapPresenceEvent;
  ...
  static $pb.PbList<CrossMapPresenceEvent> createRepeated() =>
      $pb.PbList<CrossMapPresenceEvent>();
  @$core.pragma('dart2js:noInline')
  static CrossMapPresenceEvent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CrossMapPresenceEvent>(create);
...
class QueueStatusRequest extends $pb.GeneratedMessage {
  ...
  factory QueueStatusRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory QueueStatusRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'QueueStatusRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QueueStatusRequest copyWith(void Function(QueueStatusRequest) updates) =>
      super.copyWith((message) => updates(message as QueueStatusRequest))
  ...
  static $pb.PbList<QueueStatusRequest> createRepeated() =>
      $pb.PbList<QueueStatusRequest>();
  @$core.pragma('dart2js:noInline')
  static QueueStatusRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueueStatusRequest>(create);
...
class QueueStatusResponse extends $pb.GeneratedMessage {
  ...
  factory QueueStatusResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory QueueStatusResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'QueueStatusResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QueueStatusResponse copyWith(void Function(QueueStatusResponse) updates) =>
      super.copyWith((message) => updates(message as QueueStatusResponse))
  ...
  static $pb.PbList<QueueStatusResponse> createRepeated() =>
      $pb.PbList<QueueStatusResponse>();
  @$core.pragma('dart2js:noInline')
  static QueueStatusResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueueStatusResponse>(create);
  ...
  @$pb.TagNumber(9)
  set expireReason($core.String v) {
    $_setString(8, v);
  }
...
class QueueCancelRequest extends $pb.GeneratedMessage {
  ...
  factory QueueCancelRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory QueueCancelRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'QueueCancelRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'ticket')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QueueCancelRequest copyWith(void Function(QueueCancelRequest) updates) =>
      super.copyWith((message) => updates(message as QueueCancelRequest))
  ...
  static $pb.PbList<QueueCancelRequest> createRepeated() =>
      $pb.PbList<QueueCancelRequest>();
  @$core.pragma('dart2js:noInline')
  static QueueCancelRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueueCancelRequest>(create);
...
class QueueCancelResponse extends $pb.GeneratedMessage {
  ...
  factory QueueCancelResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory QueueCancelResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'QueueCancelResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QueueCancelResponse copyWith(void Function(QueueCancelResponse) updates) =>
      super.copyWith((message) => updates(message as QueueCancelResponse))
  ...
  static $pb.PbList<QueueCancelResponse> createRepeated() =>
      $pb.PbList<QueueCancelResponse>();
  @$core.pragma('dart2js:noInline')
  static QueueCancelResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueueCancelResponse>(create);
...
class BatchPresenceJoinSignal extends $pb.GeneratedMessage {
  ...
  factory BatchPresenceJoinSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BatchPresenceJoinSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BatchPresenceJoinSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..pc<PresenceJoinSignal>(
        1, _omitFieldNames ? '' : 'joins', $pb.PbFieldType.PM,
        subBuilder: PresenceJoinSignal.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BatchPresenceJoinSignal clone() =>
      BatchPresenceJoinSignal()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BatchPresenceJoinSignal copyWith(
          void Function(BatchPresenceJoinSignal) updates) =>
      super.copyWith((message) => updates(message as BatchPresenceJoinSignal))
          as BatchPresenceJoinSignal;
  ...
  static $pb.PbList<BatchPresenceJoinSignal> createRepeated() =>
      $pb.PbList<BatchPresenceJoinSignal>();
  @$core.pragma('dart2js:noInline')
  static BatchPresenceJoinSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BatchPresenceJoinSignal>(create);
...
class BatchPresenceLeaveSignal extends $pb.GeneratedMessage {
  ...
  factory BatchPresenceLeaveSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BatchPresenceLeaveSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BatchPresenceLeaveSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..pc<PresenceLeaveSignal>(
        1, _omitFieldNames ? '' : 'leaves', $pb.PbFieldType.PM,
        subBuilder: PresenceLeaveSignal.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BatchPresenceLeaveSignal clone() =>
      BatchPresenceLeaveSignal()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BatchPresenceLeaveSignal copyWith(
          void Function(BatchPresenceLeaveSignal) updates) =>
      super.copyWith((message) => updates(message as BatchPresenceLeaveSignal))
          as BatchPresenceLeaveSignal;
  ...
  static $pb.PbList<BatchPresenceLeaveSignal> createRepeated() =>
      $pb.PbList<BatchPresenceLeaveSignal>();
  @$core.pragma('dart2js:noInline')
  static BatchPresenceLeaveSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BatchPresenceLeaveSignal>(create);
...
class MatchSignal extends $pb.GeneratedMessage {
  ...
  MatchSignal._() : super();
  factory MatchSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MatchSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, MatchSignal_Payload>
      _MatchSignal_PayloadByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MatchSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..oo(0, [10, 11, 12, 13, 14, 18, 19, 20, 21, 22])
    ..aOS(1, _omitFieldNames ? '' : 'action')
    ..aOM<KickSignal>(10, _omitFieldNames ? '' : 'kick',
        subBuilder: KickSignal.create)
    ..aOM<AssetsUpdatedSignal>(11, _omitFieldNames ? '' : 'assetsUpdated',
        subBuilder: AssetsUpdatedSignal.create)
    ..aOM<BroadcastMessageSignal>(12, _omitFieldNames ? '' : 'broadcastMessage',
        subBuilder: BroadcastMessageSignal.create)
    ..aOM<TeleportArrivalSignal>(13, _omitFieldNames ? '' : 'teleportArrival',
        subBuilder: TeleportArrivalSignal.create)
    ..aOM<ChatMessageSignal>(14, _omitFieldNames ? '' : 'chatMessage',
        subBuilder: ChatMessageSignal.create)
    ..aOM<OnlineCountChangedSignal>(
        18, _omitFieldNames ? '' : 'onlineCountChanged',
        subBuilder: OnlineCountChangedSignal.create)
    ..aOM<PresenceJoinSignal>(19, _omitFieldNames ? '' : 'presenceJoin',
        subBuilder: PresenceJoinSignal.create)
    ..aOM<PresenceLeaveSignal>(20, _omitFieldNames ? '' : 'presenceLeave',
        subBuilder: PresenceLeaveSignal.create)
    ..aOM<BatchPresenceJoinSignal>(
        21, _omitFieldNames ? '' : 'batchPresenceJoin',
        subBuilder: BatchPresenceJoinSignal.create)
    ..aOM<BatchPresenceLeaveSignal>(
        22, _omitFieldNames ? '' : 'batchPresenceLeave',
        subBuilder: BatchPresenceLeaveSignal.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  MatchSignal copyWith(void Function(MatchSignal) updates) =>
      super.copyWith((message) => updates(message as MatchSignal))
          as MatchSignal;
  ...
  @$core.pragma('dart2js:noInline')
  static MatchSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MatchSignal>(create);
  static MatchSignal? _defaultInstance;

  MatchSignal_Payload whichPayload() =>
      _MatchSignal_PayloadByTag[$_whichOneof(0)]!;
  void clearPayload() => clearField($_whichOneof(0));
  ...
  @$pb.TagNumber(11)
  set assetsUpdated(AssetsUpdatedSignal v) {
    setField(11, v);
  }
  ...
  @$pb.TagNumber(12)
  set broadcastMessage(BroadcastMessageSignal v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(13)
  set teleportArrival(TeleportArrivalSignal v) {
    setField(13, v);
  }
  ...
  @$pb.TagNumber(14)
  set chatMessage(ChatMessageSignal v) {
    setField(14, v);
  }
  ...
  @$pb.TagNumber(18)
  set onlineCountChanged(OnlineCountChangedSignal v) {
    setField(18, v);
  }
  ...
  @$pb.TagNumber(19)
  set presenceJoin(PresenceJoinSignal v) {
    setField(19, v);
  }
  ...
  @$pb.TagNumber(20)
  set presenceLeave(PresenceLeaveSignal v) {
    setField(20, v);
  }
  ...
  @$pb.TagNumber(21)
  set batchPresenceJoin(BatchPresenceJoinSignal v) {
    setField(21, v);
  }
  ...
  @$pb.TagNumber(22)
  set batchPresenceLeave(BatchPresenceLeaveSignal v) {
    setField(22, v);
  }
...
class PresenceJoinSignal extends $pb.GeneratedMessage {
  ...
  factory PresenceJoinSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PresenceJoinSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PresenceJoinSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..aOS(2, _omitFieldNames ? '' : 'nickname')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PresenceJoinSignal copyWith(void Function(PresenceJoinSignal) updates) =>
      super.copyWith((message) => updates(message as PresenceJoinSignal))
          as PresenceJoinSignal;
  ...
  static $pb.PbList<PresenceJoinSignal> createRepeated() =>
      $pb.PbList<PresenceJoinSignal>();
  @$core.pragma('dart2js:noInline')
  static PresenceJoinSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PresenceJoinSignal>(create);
...
class PresenceLeaveSignal extends $pb.GeneratedMessage {
  ...
  factory PresenceLeaveSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PresenceLeaveSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PresenceLeaveSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..aOS(2, _omitFieldNames ? '' : 'mapId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PresenceLeaveSignal copyWith(void Function(PresenceLeaveSignal) updates) =>
      super.copyWith((message) => updates(message as PresenceLeaveSignal))
          as PresenceLeaveSignal;
  ...
  static $pb.PbList<PresenceLeaveSignal> createRepeated() =>
      $pb.PbList<PresenceLeaveSignal>();
  @$core.pragma('dart2js:noInline')
  static PresenceLeaveSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PresenceLeaveSignal>(create);
...
class KickSignal extends $pb.GeneratedMessage {
  ...
  KickSignal._() : super();
  factory KickSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory KickSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'KickSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..aOS(2, _omitFieldNames ? '' : 'reason')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  KickSignal copyWith(void Function(KickSignal) updates) =>
      super.copyWith((message) => updates(message as KickSignal)) as KickSignal;
  ...
  @$core.pragma('dart2js:noInline')
  static KickSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<KickSignal>(create);
...
class AssetsUpdatedSignal extends $pb.GeneratedMessage {
  ...
  factory AssetsUpdatedSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AssetsUpdatedSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AssetsUpdatedSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'updateType')
    ..aOS(2, _omitFieldNames ? '' : 'message')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AssetsUpdatedSignal copyWith(void Function(AssetsUpdatedSignal) updates) =>
      super.copyWith((message) => updates(message as AssetsUpdatedSignal))
          as AssetsUpdatedSignal;
  ...
  static $pb.PbList<AssetsUpdatedSignal> createRepeated() =>
      $pb.PbList<AssetsUpdatedSignal>();
  @$core.pragma('dart2js:noInline')
  static AssetsUpdatedSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AssetsUpdatedSignal>(create);
...
class BroadcastMessageSignal extends $pb.GeneratedMessage {
  ...
  factory BroadcastMessageSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BroadcastMessageSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BroadcastMessageSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'messageId')
    ..aOS(2, _omitFieldNames ? '' : 'userId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BroadcastMessageSignal clone() =>
      BroadcastMessageSignal()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BroadcastMessageSignal copyWith(
          void Function(BroadcastMessageSignal) updates) =>
      super.copyWith((message) => updates(message as BroadcastMessageSignal))
          as BroadcastMessageSignal;
  ...
  static $pb.PbList<BroadcastMessageSignal> createRepeated() =>
      $pb.PbList<BroadcastMessageSignal>();
  @$core.pragma('dart2js:noInline')
  static BroadcastMessageSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BroadcastMessageSignal>(create);
...
class TeleportArrivalSignal extends $pb.GeneratedMessage {
  ...
  factory TeleportArrivalSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TeleportArrivalSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TeleportArrivalSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..aOS(2, _omitFieldNames ? '' : 'sourceMapId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TeleportArrivalSignal clone() =>
      TeleportArrivalSignal()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TeleportArrivalSignal copyWith(
          void Function(TeleportArrivalSignal) updates) =>
      super.copyWith((message) => updates(message as TeleportArrivalSignal))
          as TeleportArrivalSignal;
  ...
  static $pb.PbList<TeleportArrivalSignal> createRepeated() =>
      $pb.PbList<TeleportArrivalSignal>();
  @$core.pragma('dart2js:noInline')
  static TeleportArrivalSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TeleportArrivalSignal>(create);
...
class ChatMessageSignal extends $pb.GeneratedMessage {
  ...
  factory ChatMessageSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ChatMessageSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ChatMessageSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'messageId')
    ..aOS(2, _omitFieldNames ? '' : 'userId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ChatMessageSignal copyWith(void Function(ChatMessageSignal) updates) =>
      super.copyWith((message) => updates(message as ChatMessageSignal))
          as ChatMessageSignal;
  ...
  static $pb.PbList<ChatMessageSignal> createRepeated() =>
      $pb.PbList<ChatMessageSignal>();
  @$core.pragma('dart2js:noInline')
  static ChatMessageSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ChatMessageSignal>(create);
...
class OnlineCountChangedSignal extends $pb.GeneratedMessage {
  ...
  factory OnlineCountChangedSignal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory OnlineCountChangedSignal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'OnlineCountChangedSignal',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'lobby'),
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'total', $pb.PbFieldType.O3)
    ..m<$core.String, $core.int>(2, _omitFieldNames ? '' : 'byMap',
        entryClassName: 'OnlineCountChangedSignal.ByMapEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.O3,
        packageName: const $pb.PackageName('lobby'))
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  OnlineCountChangedSignal clone() =>
      OnlineCountChangedSignal()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  OnlineCountChangedSignal copyWith(
          void Function(OnlineCountChangedSignal) updates) =>
      super.copyWith((message) => updates(message as OnlineCountChangedSignal))
          as OnlineCountChangedSignal;
  ...
  static $pb.PbList<OnlineCountChangedSignal> createRepeated() =>
      $pb.PbList<OnlineCountChangedSignal>();
  @$core.pragma('dart2js:noInline')
  static OnlineCountChangedSignal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OnlineCountChangedSignal>(create);
