  ...
  static Future<void> show(
    ...
    return showDialog<void>(
      ...
      builder: (context) => UpdateDialog(
        ...
        canSkip: canSkip && !updateInfo.isForced,
      ),
    );
  }
}
...
class _UpdateDialogState extends State<UpdateDialog>
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          widget.updateInfo.formattedPublishDate,
                          style: const TextStyle(
                            fontSize: 12,
  ...
  Widget _buildButtons(
    ...
    final isDownloadingOrInstalling =
    ...
    if (isDownloadingOrInstalling) {
        ...
        builder: (context, child) {
          return Row(
            children: [
              ...
              if (widget.canSkip)
                SizedBox(width: 12 * (1 - _buttonWidthAnimation.value)),
              if (widget.canSkip)
                SizedBox(
                  width: 50 * (1 - _buttonWidthAnimation.value),
                  child: Opacity(
                    opacity: 1 - _buttonWidthAnimation.value,
      ...
      // 下载完成，显示"立即安装"按钮
      // 强制更新时不显示"取消"按钮
      if (_buttonAnimationController.status == AnimationStatus.completed) {
      ...
      return Row(
        children: [
          if (widget.canSkip)
            SizedBox(width: 80, child: _buildCloseButton(context)),
        ...
        builder: (context, child) {
          return Row(
            children: [
              if (widget.canSkip)
                SizedBox(
                  width: 80 * (1 - _buttonWidthAnimation.value),
                  child: Opacity(
                    opacity: 1 - _buttonWidthAnimation.value,
                    child: _buildCloseButton(context),
                  ),
  ...
  Widget _buildUpdateButton(
    ...
    switch (status) {
          ...
          child: Container(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                onTap: () {
                  context.read<UpdateBloc>().add(UpdateClearError());
                  context.read<UpdateBloc>().add(UpdateDownloadAndInstall());
                },
                child: Center(
                  child: Text(
                    '更新错误，重试',
      ...
      default:
        final fileSizeText = widget.updateInfo.fileSize > 0
              ...
              child: InkWell(
                ...
                child: Center(
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Icon(Icons.upgrade, size: 18, color: Colors.white),
                      const SizedBox(width: 8),
                      Text(
                        '立即更新$fileSizeText',
                        style: theme.textTheme.titleMedium?.copyWith(
  ...
  Widget _buildReleaseNotes() {
    final releaseNotes = widget.updateInfo.releaseNotes.isNotEmpty
