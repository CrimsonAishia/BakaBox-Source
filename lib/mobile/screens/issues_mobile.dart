                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: isDark
                            ...
                            : [const Color(0xFF0080FF), const Color(0xFF0066CC)],
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: const Color(0xFF0080FF).withValues(alpha: isDark ? 0.2 : 0.3),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Flexible(
                      child: Text(issue.authorName, style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant, fontSize: 12), overflow: TextOverflow.ellipsis, maxLines: 1),
                    ),
                    const SizedBox(width: 8),
          ...
          children: [
            Container(
              ...
              child: Icon(
                ...
                size: 36,
                color: isDark ? primaryColor.withValues(alpha: 0.9) : const Color(0xFF3B82F6),
              ),
            ),
            const SizedBox(height: 20),
            Text(
              isSearching ? '没有找到相关反馈' : '暂无反馈',
              style: TextStyle(
                color: theme.colorScheme.onSurface,
                fontSize: 16,
                fontWeight: FontWeight.w600,
