...
/// 订阅地图自动加入倒计时弹窗（全局弹窗）
class MapSubscriptionCountdownDialog extends StatelessWidget {
  final MapSubscriptionState state;

  const MapSubscriptionCountdownDialog({super.key, required this.state});
              ...
              child: Stack(
                ...
                children: [
                  CircularProgressIndicator(
                    value: state.currentAutoJoinSeconds / 60.0,
                    strokeWidth: 8,
