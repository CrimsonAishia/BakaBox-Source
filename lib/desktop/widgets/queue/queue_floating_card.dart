...
class QueueFloatingCard extends StatefulWidget {
  const QueueFloatingCard({super.key});

  @override
  State<QueueFloatingCard> createState() => _QueueFloatingCardState();
}

class _QueueFloatingCardState extends State<QueueFloatingCard>
